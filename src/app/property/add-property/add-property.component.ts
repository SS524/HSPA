...
export class AddPropertyComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.allTabsValid()) {
      ...
      this.alertify.success("Congrats! Property has been submitted successfully");
      ...
      this.alertify.error('Please review this form');
    }
  }
  ...
  get PricingInfo() {
    return this.addPropertyForm.get('PricingInfo') as FormGroup;
  }
